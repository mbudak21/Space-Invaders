...
BULLET_HIT_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'Hit.ogg'))
BULLET_FIRE_SOUND = pygame.mixer.Sound(os.path.join('Assets', 'Fire.ogg'))
WIN_SOUND = pygame.mixer.music.load(os.path.join('Assets', 'win.mp3'))
...
def draw_window(red, yellow, red_bullets, yellow_bullets, red_health, yellow_health):
	...
	#pygame.draw.rect(WIN, (255, 0, 0), yellow) # DRAW HITBOX YELLOW
	#pygame.draw.rect(WIN, (255, 0, 0), red) # DRAW HITBOX RED
...
def main():
	red = pygame.Rect(700, 300, SH, SW)
	yellow = pygame.Rect(100, 300, SH, SW)
	red_bullets = []
	yellow_bullets = []
